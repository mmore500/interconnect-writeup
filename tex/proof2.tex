...
Legenstein and Maass \citeinappendix{legenstein2001optimizing} establish a lower bound for the length of wiring required to construct a $k$-nary tree with $n$ nodes on a one-dimensional $L_1$ grid,
\begin{align*}
\Omega(n \log n).
\end{align*}
...
To tractably extend our analysis to three-dimensional meshes, rather than all small-world graphs we will specifically analyze the wiring cost of ideal space-filling trees \citeinappendix{kuffner2009space}.
